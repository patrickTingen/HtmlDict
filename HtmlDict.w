...
DEFINE VARIABLE fiOutputDirectory AS CHARACTER FORMAT "X(256)":U INITIAL "c:~\work~\HtmlDict~\" 
...
DEFINE VARIABLE rsFieldOrder AS CHARACTER INITIAL "_order" 
...
DEFINE VARIABLE tgSkipIfUnchanged AS LOGICAL INITIAL no 
...
/*----------------------------------------------------------------------------
  ...
  &if "{&uib_is_running}" <> "" &then
    gcInstallDir = 'c:\Data\Dropbox\Progress\Code\HtmlDict-2\'.
  &else
